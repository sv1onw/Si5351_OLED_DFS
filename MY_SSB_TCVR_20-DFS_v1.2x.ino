...
#define SW 11                                               // the Digital pin where the Rotary Encoder's push button switch is connected
...
void loop() {
  ...
  if (result == DIR_CW)  {                                 // freq up
    ...
    freqSet(freq - FREQSSBFIL, 0);                         // update CLK0/freq 
    dispUpdate();
  }
